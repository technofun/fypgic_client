...
function MarksForm() {
    ...
    const { sem1, setSem1 } = useContext(StudentData)

    const [subjectNames, setSubjectNames] = useState({
        subject1Name: "Introduction to ICT",
        subject2Name: "Programming Fundamentals",
        subject3Name: "English Composition & Comprehension",
        subject4Name: "Calculus and Analytical Geometry ",
        subject5Name: "Chinese Language"
    })
    ...
    return (
        <div>
            <p className="display-4">semester1</p>
                ...
                <table className="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input
                                name="chineseMid"
                                value={midMarks.chineseMid}
                                onChange={handleMidMarks}
                                type="number"
                                className="form-control" />
                            </td>
                            <td><input
                                value={sessionalMarks.chineseSessional}
                                onChange={handleSessionalMarks}
                                name="chineseSessional"
                                type="number"
                                className="form-control" /></td>
                            <td><input
                                name="chineseFinal"
                                value={finalMarks.chineseFinal}
                                onChange={handleFinalMarks}
                                type="number"
                                className="form-control" /></td>
                            <td>3(3-0)</td>
                            <td>
                                <input
                                    disabled={true}
                                    placeholder={parseInt(midMarks.chineseMid) + parseInt(sessionalMarks.chineseSessional) + parseInt(finalMarks.chineseFinal)}
